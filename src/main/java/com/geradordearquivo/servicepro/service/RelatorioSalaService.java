...
import com.geradordearquivo.servicepro.repository.SalaRepository;
...
@Service
public class RelatorioSalaService {
    ...
    public List<OrdemDeServicoSalaMongo> todasOSsala(LocalDateTime datainicial, LocalDateTime datafinal) {
        return repository.findToPeriod(datainicial,datafinal);
    }

    public byte[] criarPdf(List<OrdemDeServicoSalaMongo> listaDeOS) {
        try{
            ...
            for (OrdemDeServicoSalaMongo ordemDeServico : listaDeOS) {
