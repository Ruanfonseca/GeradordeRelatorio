...
@Service
public class RelatorioWifiService {

    @Autowired
    public WifiRepository repository;

    public List<OrdemDeServicoMongo> todasOSwifi(LocalDateTime datainicial, LocalDateTime datafinal) {

        return repository.findToPeriod(datainicial,datafinal);
    }


    public byte[]  criarPdf(List<OrdemDeServicoMongo> listaDeOS){
        try{
        ...
        for (OrdemDeServicoMongo ordemDeServico : listaDeOS) {
